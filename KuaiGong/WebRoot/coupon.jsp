...
var pageSize=8;
	...
	$("#table_tbody").empty();
			$.each(data,function(){
				$("#table_tbody").append("<tr>" + "<td>" +this.id +  "</td>" + "<td>" +this.erid +  "</td>"+
					  "<td>"+b.decode(this.username)+ "</td>" + "<td>"
						+b.decode(this.name)+"</td>"+"<td>"+this.money+"</td>"+"<td>" +this.status +"</td>"+"<td>" +this.endtime +"</td>"+"</td>"+"<td><a href='user/updataCoupon.jsp?id="
																		+ this.id
																		+ "&money="
																		+ this.money
																		+ "&status="
		...
		function selectDisCountToUserInfo(page){
		var id=$("#id").val();
        var page=page;
        var pageSize=8;
        var b=new Base64();
	...
	$("#table_tbody").empty();
			$.each(data,function(){
				$("#table_tbody").append("<tr>" + "<td>" +this.id +  "</td>" + "<td>" +this.erid +  "</td>"+
					  "<td>"+b.decode(this.username)+ "</td>" + "<td>"
						+b.decode(this.name)+"</td>"+"<td>"+this.money+"</td>"+"<td>" +this.status +"</td>"+"<td>" +this.endtime +"</td>"+"<td><a href='user/updataCoupon.jsp?id="
																		+ this.id
																		+ "&money="
																		+ this.money
																		+ "&status="
