...
<script type="text/javascript" src="js/queryBlacklist.js"></script>
...
<div class="tools">
    	...
    	<ul class="toolbar">
        <li><input name="id" id = "query" type="text" class="id query quee" onload="queryUser(1)" value="" placeholder="输入姓名"/>
         <li><input id = "page" type="hidden" class="id query quee"  value="<%=page1%>" />
       <button onclick="queryBlacklist()">查询</button></li>
    </ul>
