...
<link href="css/add.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="js/GRupdateWallet.js"></script>
  </head>
  <%
...
function test1(obj){
    ...
    <form id="userInfo" method="post">
     ...
     <ul class="userInfo userInfoPre">
       <li><pre></pre><input id= "page1" type="hidden" class="id query" value="<%=page1%>"  readonly="readonly"/></li>
   ...
   <li><pre>手  机  号</pre><input name="longitude" id="username" type="text" class="longitude query" value="<%=username%>" readonly="readonly"/><font color="red" id="f4"></font></li>
     ...
     <li><pre>工 人 姓 名</pre><input name="latitude" id="name" type="text" class="latitude querys" value="<%=name %>" readonly="readonly"/></li>
    ...
    <li><pre>可提现余额</pre><input name="latitude" id="residue" type="text" class="latitude querys" value="<%=residue %>" readonly="readonly"/></li><div><font color="red" id="str1"></font></div>
    
   
   <li><input id="update" name="update" type="button" class="update selectUser" value="更新" onclick="GRupdateWallet()"/></li>
    </ul>    
