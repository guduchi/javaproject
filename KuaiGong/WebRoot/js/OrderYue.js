...
function selectPay(){
	...
	$.post("OrderForm/selectPaymentYue.action",{page:page,pageSize:pageSize,id:id,eename:eename,name:name,btu:btu,starttime:starttime,endtime:endtime},
			function(data) {
		if (data != null) {
			selectSum(Math.ceil(data/22),page);
		}														
	}, "json");
	$.post("OrderForm/selectPaymentYueMoney.action",{id:id,name:name,eename:eename,starttime:starttime,endtime:endtime,btu:btu},function(data){
		if(data!=null){
		$("#fontCount").html(data.paymentYueCount);
	}
},"json");
	$.post("OrderForm/selectPaymentYueCount.action",{id:id,name:name,eename:eename,starttime:starttime,endtime:endtime,btu:btu},function(data){
		if(data!=null){
			$("#count").html(data);
		}
	},"json");
	$.post("OrderForm/selectPaymentYuePage.action",{page:page,pageSize:pageSize,id:id,eename:eename,name:name,btu:btu,starttime:starttime,endtime:endtime},
			function(data) {
		if (data != null) {
			$("#table_tbody").empty();
			$.each(data,function() {
...
function selectPaymentYuePage(page){
	var page=page;
	var pageSize = 22;
	var b = new Base64();
	var id = $("#id").val();
