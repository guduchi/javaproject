function queryUserPage2(page){
	...
	var page=page;
	var pageSize=8;
$.post("erlocation/selectNameOrUsername1.action",{query:query,page:page,pageSize:pageSize},function(data){	if(data!=null){
	selectSum(Math.ceil(data / 8));
	}
},"json");
$.post("erlocation/selectNameOrUsernameByPaGe.action",{query:query,page:page,pageSize:pageSize},function(data){
	...
	if (data != null) {
		...
		$.each(data, function() {
			...
			$("#table_tbody").append("<tr>"
					...
					+"<td><a href=javascript:void(0)  onclick =deleteByid("+this.id+") >删除</a>"+"</td>"+ "</tr>");
...
function selectNameOrUsernameByPaGe(page){
	var query=$("#query").val();
	var b=new Base64();
...
function selectNumber() {
	...
	$("[name=page]").html(page);
	selectNameOrUsernameByPaGe(page);
}
//��һҳ
function nextPage() {
