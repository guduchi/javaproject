...
function selectWorkerWallet(){
  ...
  var pageSize=22;
  $.post("wallet/selectWorkerWalletPage.action",{id:id,page:page,pageSize:pageSize},function(data){
	  if(data != null){
		  selectSum(Math.ceil(data/22),page);
	  }
  },"json");
  
  $.post("wallet/selectWorkerWalletInfo.action",{id:id,page:page,pageSize:pageSize},function(data){
	if(data != null){
		$("#table_tbody").empty();
		$.each(data, function() {
...
function selectWorkerWalletInfo(page){
	var b=new Base64();
	var id=$("#id").val();
	var page=page;
	var pageSize=22;
