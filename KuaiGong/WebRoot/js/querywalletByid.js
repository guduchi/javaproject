...
function querywalletPage(){
	var b=new Base64();
	var id=$("#id").val();
	var page=1;
    var pageSize=22;
	$.post("wallet1/selectQueryWalletByid.action",{page:page,pageSize:pageSize,id:id},function(data){
		if(data!=null){
			selectSum(Math.ceil(data/22),page);	
		}
	},"json");
	$.post("wallet1/selectQueryWalletByidPage.action",{page:page,pageSize:pageSize,id:id},function(data){
		if(data!=null){
			$("#table_tbody").empty();
			$.each(data, function() {
...
function selectQueryWalletPage(page){
	var b=new Base64();	
	var id=$("#id").val();
	var page=page;
	var pageSize=22;
