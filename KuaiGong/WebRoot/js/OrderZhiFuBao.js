...
function selectPay(){
	...
	$.post("OrderForm/selectPaymentZhiFuBao.action",{page:page,pageSize:pageSize,id:id,eename:eename,name:name,btu:btu,starttime:starttime,endtime:endtime},
			function(data) {
		if (data != null) {
			selectSum(Math.ceil(data/22),page);
		}														
	}, "json");
	$.post("OrderForm/selectPaymentZhiFuBaoMoney.action",{id:id,name:name,eename:eename,starttime:starttime,endtime:endtime,btu:btu},function(data){
		if(data!=null){
		$("#fontCount").html(data.paymentZhiFuBaoMoney);
	}
},"json");
	$.post("OrderForm/selectPaymentZhiFuBaoCount.action",{id:id,name:name,eename:eename,starttime:starttime,endtime:endtime,btu:btu},function(data){
		if(data!=null){
			$("#count").html(data);
		}
	},"json");
	$.post("OrderForm/selectPaymentZhiFuBaoPage.action",{page:page,pageSize:pageSize,id:id,eename:eename,name:name,btu:btu,starttime:starttime,endtime:endtime},
			function(data) {
		if (data != null) {
			$("#table_tbody").empty();
			$.each(data,function() {
...
function selectPaymentZhiFuBaoPage(page){
	var page=page;
	var pageSize = 22;
	var b = new Base64();
	var id = $("#id").val();
...
function selectNumber() {
	...
	$("[name=page]").html(page);
	selectPaymentZhiFuBaoPage(page);
}
//下一页
function nextPage() {
