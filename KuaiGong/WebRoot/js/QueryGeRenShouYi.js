...
function QueryGeRenShouYi(page){
	var b=new Base64();
	var page=page;
	var pageSize=8;
	...
	var id=$("#id").val();
	$.post("eeuser/queryshouyi.action",{page:page,pageSize:pageSize,id:id,starttime:starttime,endtime:endtime},function(data){
		if(data!=null){
			selectSum(Math.ceil(data/8));
		}
	},"json");
	$.post("eeuser/queryCountMoney.action",{id:id,starttime:starttime,endtime:endtime},function(data){
		if(data!=null){
			$("#count").html(data);
		}
	},"json");
	$.post("eeuser/queryshouyiInfo.action",{page:page,pageSize:pageSize,id:id,starttime:starttime,endtime:endtime},function(data){
		if(data!=null){
			$("#table_tbody").empty();
			$.each(data,function(){
