...
$.post("Detail/selectMoney.action",{page:page,pageSize:pageSize,salesmanName:salesmanName,username:username,desc:desc,starttime:starttime,endtime:endtime},
			function(data) {
				if (data != null) {
					selectSum(Math.ceil(data/22),page);
				}
			}, "json");
$.post("Detail/count.action",{salesmanName:salesmanName,username:username,desc:desc,starttime:starttime,endtime:endtime},function(data){
	if(data!=null){
		$("#count").html(data);
	}
},"json");
$.post("Detail/selectMoneyPage.action",{page:page,pageSize:pageSize,salesmanName:salesmanName,username:username,desc:desc,starttime:starttime,endtime:endtime},
		function(data) {
			if (data != null) {
				$("#table_tbody").empty();
				$.each(data,function() {
