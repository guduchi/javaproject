...
<script type="text/javascript" src="js/SalesmanSignIn.js"></script>
...
<div class="rightinfo">
   ...
   <li>   <input id = "page" type="hidden" class="query quee" onload="queryUser(1)"  value="<%=page1%>" />
    ...
    <th width="130px;" id="Id">业务员编号</th>
    <th width="180px;" id="Id">业务员电话</th>
    <th width="120px;" id="Id">业务员姓名</th>
    <th>签到地点</th>
    <th>签到时间</th>
    <th width="100px;" id="Id">签到状态</th>
    <th width="120px;" id="Id">签到位置</th>
   </tr>
