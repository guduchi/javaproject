...
<script type="text/javascript" src="js/EmployeeHourLength.js"></script>
...
<body>
    ...
    <li><a href="EmployeeHourLength.jsp">累计时间10小时</a></li>
    </ul>
    </div>
<div class="rightinfo">
    	<ul class="toolbar">
	<li><input name="name" id="name" type="text" class="query quee" onload="queryUser(1)" value="" placeholder="工人姓名"/>
	<li><input name="username" id="username" type="text" class="query quee" onload="queryUser(1)" value="" placeholder="工人电话"/>
	<button id="toolbarBut" onclick="Hourleng(1)">查询</button></li>
        </ul>
</div>
