...
<script type="text/javascript" src="js/jquery.js"></script>
 <script type="text/javascript" src="js/selectAppBySalesman.js"></script>
...
<ul class="toolbar toolbarRight">
     <li><input id="id" type="hidden"  class="id query quee toolbarRightR" value="<%=id%>"/>
    <input id = "ername"  type="text" class="query quee toolbarRightR" onload="queryUser(1)"  value="" placeholder="雇主姓名"/>
	<input id = "erid"  type="text" class="query quee toolbarRightR" onload="queryUser(1)"  value="" placeholder="雇主编号"/>
	<button class="toolbarRightbor" onclick="orderform(1)">查询</button></li>
    </ul>
</div>
