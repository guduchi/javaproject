...
public class SendSMSCount {
	 ...
	 */
	public SendSMSCount(String mobile) {
		this.mobile = mobile;
	}
	...
	public String sendAuthCodeThree() throws IOException {

		String authCode = getAuthCodeThree();

		// 发送内容
		String content = "【快工】：您" + authCode + "请注意查收";
