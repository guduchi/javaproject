...
public class SendSMSModle {
	 ...
	 */
	public SendSMSModle(String mobile) {
		this.mobile = mobile;
	}



	public String getAuthCodeThree() {

		String authCode = "的优惠券已发送！" ;
	...
	public String sendAuthCodeThree(String newcontent) throws IOException {

		//String authCode =newcontent;

		// 发送内容
		String content =newcontent + "【快工】";
